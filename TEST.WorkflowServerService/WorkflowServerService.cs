...
namespace TEST.WorkflowServerService {
    public partial class TESTWorkflowServer  : System.ServiceProcess.ServiceBase {
        private WorkflowServer server;
        protected override void OnStart(string[] args) {
            if(server == null) {
                ServerApplication serverApplication = new ServerApplication();
                serverApplication.ApplicationName = "TEST";
                ...
                serverApplication.Modules.Add(new TEST.Module.TESTModule());
                serverApplication.Modules.Add(new TEST.Module.Win.TESTWindowsFormsModule());
                serverApplication.Modules.Add(new TEST.Module.Web.TESTAspNetModule());
